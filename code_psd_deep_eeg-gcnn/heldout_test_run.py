...
def collect_metrics(y_probs_test, y_true_test, y_pred_test, sample_indices_test,
	...
	dataset_index = pd.read_csv("../../figshare_upload/master_metadata_index.csv")
...
if __name__ == "__main__":
	...
	MASTER_DATASET_INDEX = pd.read_csv("../../figshare_upload/master_metadata_index.csv")
	...
	X = load("../../figshare_upload/psd_features_data_X", mmap_mode='r')
	y = load("../../figshare_upload/labels_y", mmap_mode='r')
	...
	for FOLD_IDX in range(10):
		...
		checkpoint = torch.load("../../figshare_upload/psd_deep_eeg-gcnn/{}_fold_{}.ckpt".format(EXPERIMENT_NAME, FOLD_IDX), map_location=DEVICE)
